...
//        mCombinedChart.setDrawGridBackground(false);
        ...
        rightAxis.setEnabled(false); //横向轴线隐藏
...
//        });
     ...
     * @return
     */
    private LineData getLineData(List<Integer> lineChartY, String lineName, int lineColor) {
     ...
     * @return
     */
    private LineData getLineData(List<List<Integer>> lineChartYs, List<String> lineNames, List<Integer> lineColors) {
        LineData lineData = new LineData();
    ...
    private BarData getBarData(List<Integer> barChartY, String barName, int barColor) {
    ...
    private BarData getBarData(List<List<Integer>> barChartYs, List<String> barNames, List<Integer> barColors) {
    ...
    public void showCombinedChart(
            List<String> xAxisValues, List<Integer> barChartY, List<Integer> lineChartY
    ...
    public void showCombinedChart(
            List<String> xAxisValues, List<List<Integer>> barChartYs, List<List<Integer>> lineChartYs,
