...
public class CustomBarChart extends View {
    ...
    public void init() {
        ...
        paintAxes.setColor(ContextCompat.getColor(getContext(), R.color.colorBlack));
        paintAxes.setStrokeWidth(4);
        paintAxes.setTextSize(18);
        ...
        paintCoordinate.setColor(ContextCompat.getColor(getContext(), R.color.colorBlack));
        //坐标字体大小
